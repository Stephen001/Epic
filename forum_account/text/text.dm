...
// File:    text.dm
// Library: Forum_account.Text
// Author:  Forum_account
//
// Contents:
//   This library contains several text procs. There's
//   not a lot of content here, less than most of my
//   libraries, but these functions are commonly used
//   by other libraries so it's worth giving them their
//   own library.
